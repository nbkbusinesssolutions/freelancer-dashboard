...
function transformToDb(body: any) {
  return {
    ...
    domain_provider: body.domainProvider,
    domain_email_id: body.domainEmailId,
    domain_username: body.domainUsername,
    deployment_email_id: body.deploymentEmailId,
    deployment_username: body.deploymentUsername,
    ...
    status: body.status,
    project_amount: body.projectAmount,
